            ...
            <div class="list-group"> 
                ...
                <div class="list-group-item"> 
                    ...
                    <div class="row-content">
                        ...
                        <a href="/admin/categories" class="btn btn-default btn-raised">All Categories</a>                             <a href="/admin/categories/create" class="btn btn-primary btn-raised">New Category</a> 
                    </div> 
                </div>
                <div class="list-group-separator"></div>
            </div>
